...
const form = ref<Omit<CreateUpdateZoneDto, 'warehouseId'>>({ code: '', name: '', zoneType: 0 })
...
const zoneTypeOptions = [
  { label: '存储区', value: ZoneType.Storage },
  { label: '收货区', value: ZoneType.Receiving },
  { label: '发货区', value: ZoneType.Shipping },
]
